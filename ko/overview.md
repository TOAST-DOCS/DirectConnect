...
| 연결 방식 1 | 전용 연결 - 회선 사업자 통한 전용회선 연결 방식<br>- KT, LGU, SKB, 드림라인, 세종텔레콤 중 선택 가능 (NHN Cloud에서 회선 계약 및 개통 진행)|
| 연결 방식 2 | 호스팅 연결 - N/W 파트너 통한 클라우드 플랫폼 연결 방식<br>- KINX 클라우드 허브 (https://www.kinx.net/service/cloudhub/)<br>- LGU 클라우드 멀티커넥트 (https://www.lguplus.com/biz/all/telecom/idc/cloud-connection-service/B000000036)<br>- 드림라인 Cloud eXchange Platform (https://www.dreamline.co.kr/service/cloud_overview.php)|
