...
## Network > Direct Connect > 콘솔 사용 가이드 { #network-direct-connect-console-user-guide }
...
### STEP 1. 서비스 이용 신청 { #step-1-application-for-service-use }
...
### STEP 2. 전용 회선 준비 { #step-2-prepare-a-dedicated-line }
...
### STEP 3. 고객 인프라와 NHN Cloud 연결 { #step-3-connect-customer-infrastructure-with-nhn-cloud }
